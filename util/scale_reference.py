...
# Frequencies list
FREAKwencies = [55.0, 110.0, 51.9131, 103.826, 61.7354, 123.471, 58.2705, 116.541, 32.7032, 65.4064, 36.7081, 73.4162, 34.6478, 69.2957, 41.2034, 82.4069, 38.8909, 77.7817, 43.6535, 87.3071, 48.9994, 97.9989, 46.2493, 92.4986]
...
def b_minor():
    return [frequency_to_midi(FREAKwencies[i]) for i in [11, 13, 14, 16, 18, 19, 21, 23]]

def b_major():
    return [frequency_to_midi(FREAKwencies[i]) for i in [11, 13, 15, 16, 18, 20, 22, 23]]

# Example usage
scale_a_minor = a_minor()
print("A Minor Scale MIDI Notes:", scale_a_minor)
